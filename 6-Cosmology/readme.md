...
## Crossing Into the Umbra (Example)

- **Allowed:** Theurge Gift “Umbral Passage,” Sphere: Spirit 3, Ritual: “Moon Gate”
- **Not Allowed:** Psychic Projection alone, unless paired with Spirit-based powers
- **Gauntlet Rating:**
  - Knoxville City: 8
  - Cades Cove: 5
  - Sept of the Sentinel: 3

## Psychic Projection (Example)

- **Requires:** Mind 4 + Spirit 2 or approved Numina
- **Cannot Interact Physically**
- **Can Observe and Communicate** with Umbra-active beings

## Shadowlands Travel (Example)

- **Requires:** Necromantic Ritual or Arcanoi: Argos
- **Shroud Rating:**
  - City Centers: 7
  - Haunts: 4
- **Spectres present** in Oak Ridge tunnels (combat risk)